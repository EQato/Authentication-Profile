...
<br>
<div><a href="http://studentclub.al/card/index.php/admin/exported" >kliko</a>
...
$tableName3="university";	
	$targetpage = "gjejemri"; 	
	$limit = 10; 
	$query = "SELECT *FROM login where login.name='".$emri."'";
	...
	WHERE login.name='".$emri."' or login.name=' ".$emri."' or login.name='".$emri." ' or login.name=' ".$emri." '
	LIMIT $start, $limit";
	...
	{	
		...
		// Previous
		if ($page > 1){
			$paginate.= "<a href='$targetpage?emri=".$emri."&page=$prev'>previous</a>";
		}else{
		...
		{	
			for ($counter = 1; $counter <= $lastpage; $counter++)
			{
				if ($counter == $page){
					...
					$paginate.= "<a href='$targetpage?emri=".$emri."&page=$counter'>$counter</a>";}					
			}
		}
		elseif($lastpage > 5 + ($stages * 2))	// Enough pages to hide a few?
		{
			...
			if($page < 1 + ($stages * 2))		
			{
				...
				$paginate.= "...";
				$paginate.= "<a href='$targetpage?emri=".$emri."&page=$LastPagem1'>$LastPagem1</a>";
				$paginate.= "<a href='$targetpage?emri=".$emri."&page=$lastpage'>$lastpage</a>";		
			}
			// Middle hide some front and some back
			elseif($lastpage - ($stages * 2) > $page && $page > ($stages * 2))
			{
				$paginate.= "<a href='$targetpage?emri=".$emri."&page=1'>1</a>";
				$paginate.= "<a href='$targetpage?emri=".$emri."&page=2'>2</a>";
				$paginate.= "...";
			...
			else
			{
				...
				// Next
		if ($page < $counter - 1){ 
			$paginate.= "<a href='$targetpage?emri=".$emri."&page=$next'>next</a>";
		}else{
