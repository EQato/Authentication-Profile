...
$tableName3="university";	
	...
	WHERE personal_data.shteti='".$shteti."' or personal_data.shteti=' ".$shteti."' or personal_data.shteti='".$shteti." ' or personal_data.shteti=' ".$shteti." ' 
	or login.name='".$shteti."' or login.name=' ".$shteti."' or login.name='".$shteti." ' or login.name=' ".$shteti." ' 
	or login.surname='".$shteti."' or login.surname=' ".$shteti."' or login.surname='".$shteti." ' or login.surname=' ".$shteti." '
	or personal_data.qyteti='".$shteti."' or personal_data.qyteti=' ".$shteti."' or personal_data.qyteti='".$shteti." ' or personal_data.qyteti=' ".$shteti." '
	or university.university='".$shteti."' or university.university=' ".$shteti."' or university.university='".$shteti." ' or university.university=' ".$shteti." '";
	...
	{	
		...
		// Previous
		if ($page > 1){
			$paginate.= "<a href='$targetpage?tegjitha=".$shteti."&page=$prev'>previous</a>";
		}else{
		...
		{	
			for ($counter = 1; $counter <= $lastpage; $counter++)
			{
				if ($counter == $page){
					...
					$paginate.= "<a href='$targetpage?tegjitha=".$shteti."&page=$counter'>$counter</a>";}					
			}
		}
		elseif($lastpage > 5 + ($stages * 2))	// Enough pages to hide a few?
		{
			...
			if($page < 1 + ($stages * 2))		
			{
				...
				$paginate.= "...";
				$paginate.= "<a href='$targetpage?tegjitha=".$shteti."&page=$LastPagem1'>$LastPagem1</a>";
				$paginate.= "<a href='$targetpage?tegjitha=".$shteti."&page=$lastpage'>$lastpage</a>";		
			}
			// Middle hide some front and some back
			elseif($lastpage - ($stages * 2) > $page && $page > ($stages * 2))
			{
				$paginate.= "<a href='$targetpage?tegjitha=".$shteti."&page=1'>1</a>";
				$paginate.= "<a href='$targetpage?tegjitha=".$shteti."&page=2'>2</a>";
				$paginate.= "...";
			...
			else
			{
				...
				// Next
		if ($page < $counter - 1){ 
			$paginate.= "<a href='$targetpage?tegjitha=".$shteti."&page=$next'>next</a>";
		}else{
