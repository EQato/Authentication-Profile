...
<?php
 if( $_GET["universitet"])
  {  
     $universitet=$_GET['universitet'];
  }

	$tableName="login";
$tableName2="personal_data";
$tableName3="university";	
	$targetpage = "gjejuniver"; 	
	$limit = 10; 
	$query = "SELECT * 
	FROM login 
	...
	WHERE university.university='".$universitet."'";
	...
	INNER JOIN university 
	on personal_data.university=university.id 
	WHERE university.university='".$universitet."' or university.university=' ".$universitet."' or university.university='".$universitet." ' or university.university=' ".$universitet." '
	LIMIT $start, $limit";
	...
	{	
		...
		// Previous
		if ($page > 1){
			$paginate.= "<a href='$targetpage?universitet=".$universitet."&page=$prev'>previous</a>";
		}else{
		...
		{	
			for ($counter = 1; $counter <= $lastpage; $counter++)
			{
				if ($counter == $page){
					...
					$paginate.= "<a href='$targetpage?universitet=".$universitet."&page=$counter'>$counter</a>";}					
			}
		}
		elseif($lastpage > 5 + ($stages * 2))	// Enough pages to hide a few?
		{
			...
			if($page < 1 + ($stages * 2))		
			{
				...
				$paginate.= "...";
				$paginate.= "<a href='$targetpage?universitet=".$universitet."&page=$LastPagem1'>$LastPagem1</a>";
				$paginate.= "<a href='$targetpage?universitet=".$universitet."&page=$lastpage'>$lastpage</a>";		
			}
			// Middle hide some front and some back
			elseif($lastpage - ($stages * 2) > $page && $page > ($stages * 2))
			{
				$paginate.= "<a href='$targetpage?universitet=".$universitet."&page=1'>1</a>";
				$paginate.= "<a href='$targetpage?universitet=".$universitet."&page=2'>2</a>";
				$paginate.= "...";
			...
			else
			{
				...
				// Next
		if ($page < $counter - 1){ 
			$paginate.= "<a href='$targetpage?universitet=".$universitet."&page=$next'>next</a>";
		}else{
