...
$tableName3="university";	
	$targetpage = "gjejmbiemri"; 	
	$limit = 10; 
	$query = "SELECT *FROM login where login.surname='".$mbiemri."'";
	...
	WHERE login.surname='".$mbiemri."' or login.surname=' ".$mbiemri."' or login.surname='".$mbiemri." ' or login.surname=' ".$mbiemri." '
	LIMIT $start, $limit";
	...
	{	
		...
		// Previous
		if ($page > 1){
			$paginate.= "<a href='$targetpage?mbimbiemri=".$mbiemri."&page=$prev'>previous</a>";
		}else{
		...
		{	
			for ($counter = 1; $counter <= $lastpage; $counter++)
			{
				if ($counter == $page){
					...
					$paginate.= "<a href='$targetpage?mbiemri=".$mbiemri."&page=$counter'>$counter</a>";}					
			}
		}
		elseif($lastpage > 5 + ($stages * 2))	// Enough pages to hide a few?
		{
			...
			if($page < 1 + ($stages * 2))		
			{
				...
				$paginate.= "...";
				$paginate.= "<a href='$targetpage?mbiemri=".$mbiemri."&page=$LastPagem1'>$LastPagem1</a>";
				$paginate.= "<a href='$targetpage?mbiemri=".$mbiemri."&page=$lastpage'>$lastpage</a>";		
			}
			// Middle hide some front and some back
			elseif($lastpage - ($stages * 2) > $page && $page > ($stages * 2))
			{
				$paginate.= "<a href='$targetpage?mbiemri=".$mbiemri."&page=1'>1</a>";
				$paginate.= "<a href='$targetpage?mbiemri=".$mbiemri."&page=2'>2</a>";
				$paginate.= "...";
			...
			else
			{
				...
				// Next
		if ($page < $counter - 1){ 
			$paginate.= "<a href='$targetpage?mbiemri=".$mbiemri."&page=$next'>next</a>";
		}else{
