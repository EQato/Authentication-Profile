...
$tableName3="university";	
	$targetpage = "gjejshtet"; 	
	$limit = 10; 
	$query = "SELECT *FROM personal_data where personal_data.shteti='".$shteti."'";
	...
	{	
		...
		// Previous
		if ($page > 1){
			$paginate.= "<a href='$targetpage?shteti=".$shteti."&page=$prev'>previous</a>";
		}else{
		...
		{	
			for ($counter = 1; $counter <= $lastpage; $counter++)
			{
				if ($counter == $page){
					...
					$paginate.= "<a href='$targetpage?shteti=".$shteti."&page=$counter'>$counter</a>";}					
			}
		}
		elseif($lastpage > 5 + ($stages * 2))	// Enough pages to hide a few?
		{
			...
			if($page < 1 + ($stages * 2))		
			{
				...
				$paginate.= "...";
				$paginate.= "<a href='$targetpage?shteti=".$shteti."&page=$LastPagem1'>$LastPagem1</a>";
				$paginate.= "<a href='$targetpage?shteti=".$shteti."&page=$lastpage'>$lastpage</a>";		
			}
			// Middle hide some front and some back
			elseif($lastpage - ($stages * 2) > $page && $page > ($stages * 2))
			{
				$paginate.= "<a href='$targetpage?shteti=".$shteti."&page=1'>1</a>";
				$paginate.= "<a href='$targetpage?shteti=".$shteti."&page=2'>2</a>";
				$paginate.= "...";
			...
			else
			{
				...
				// Next
		if ($page < $counter - 1){ 
			$paginate.= "<a href='$targetpage?shteti=".$shteti."&page=$next'>next</a>";
		}else{
